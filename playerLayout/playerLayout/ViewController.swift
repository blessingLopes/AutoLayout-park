...
class PlayerViewController: UIViewController {
    ...
    //TODO:- Add a blury view behind the IOS status bar
    ...
    private func makeButtonWithTitle(_ title: String,  fontSize: Int) -> UIButton {
        ...
        button.backgroundColor = #colorLiteral(red: 1.011019826, green: 0.1491314173, blue: -0.02277684398, alpha: 1)
    ...
    private func setupStackViews(){
        ...
        at.backgroundColor = #colorLiteral(red: 1.011019826, green: 0.1491314173, blue: -0.02277684398, alpha: 1)
        ...
        trackTime.backgroundColor = #colorLiteral(red: 1.011019826, green: 0.1491314173, blue: -0.02277684398, alpha: 1)
        trackTime.textAlignment = .right
        trackTime.isEditable = false
        
        
        let leftDummyView = UIView()
        leftDummyView.backgroundColor = #colorLiteral(red: 1.011019826, green: 0.1491314173, blue: -0.02277684398, alpha: 1)
        
        let rightDummyView = UIView()
        rightDummyView.backgroundColor = #colorLiteral(red: 1.011019826, green: 0.1491314173, blue: -0.02277684398, alpha: 1)
        ...
        albumTitle.backgroundColor = #colorLiteral(red: 1.011019826, green: 0.1491314173, blue: -0.02277684398, alpha: 1)
        ...
        trackTitle.backgroundColor = #colorLiteral(red: 1.011019826, green: 0.1491314173, blue: -0.02277684398, alpha: 1)
        ...
        sliderDemo.tintColor = #colorLiteral(red: 0, green: 0, blue: 0, alpha: 1)
        sliderDemo.value = 40
        sliderDemo.contentMode = .scaleAspectFill
        sliderDemo.clipsToBounds = true
        sliderDemo.backgroundColor = #colorLiteral(red: 1.011019826, green: 0.1491314173, blue: -0.02277684398, alpha: 1)
        sliderDemo.maximumTrackTintColor = #colorLiteral(red: 1.011019826, green: 0.1491314173, blue: -0.02277684398, alpha: 1)
        sliderDemo.thumbTintColor = .black
        
        
        let leftSliderDummyView = UIView()
        leftSliderDummyView.backgroundColor = #colorLiteral(red: 1.011019826, green: 0.1491314173, blue: -0.02277684398, alpha: 1)
        
        let rightSliderDummyView = UIView()
        rightSliderDummyView.backgroundColor = #colorLiteral(red: 1.011019826, green: 0.1491314173, blue: -0.02277684398, alpha: 1)
